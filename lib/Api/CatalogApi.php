...
use SellerLegend\AmazonSellingPartnerAPI\Models\Catalog\GetCatalogItemResponse;
use SellerLegend\AmazonSellingPartnerAPI\Models\Catalog\ListCatalogCategoriesResponse;
use SellerLegend\AmazonSellingPartnerAPI\Models\Catalog\ListCatalogItemsResponse;
...
class CatalogApi {
     ...
     * @param string $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @return array of \SellerLegend\AmazonSellingPartnerAPI\Models\Catalog\GetCatalogItemResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws InvalidArgumentException
     *
     * @throws ApiException             on non-2xx response
     */
     ...
     * @param string $seller_sku Used to identify items in the given marketplace. SellerSKU is qualified by the seller&#x27;s SellerId, which is included with every operation that you submit. (optional)
     *
     * @return array of \SellerLegend\AmazonSellingPartnerAPI\Models\Catalog\ListCatalogCategoriesResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws InvalidArgumentException
     *
     * @throws ApiException             on non-2xx response
     */
     ...
     * @param string $jan A Japanese article number that uniquely identifies the product, manufacturer, and its attributes. (optional)
     *
     * @return array of \SellerLegend\AmazonSellingPartnerAPI\Models\Catalog\ListCatalogItemsResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException             on non-2xx response
     * @throws InvalidArgumentException
     *
     */
