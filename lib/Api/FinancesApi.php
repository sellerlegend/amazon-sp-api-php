...
use SellerLegend\AmazonSellingPartnerAPI\Models\Finances\ListFinancialEventGroupsResponse;
use SellerLegend\AmazonSellingPartnerAPI\Models\Finances\ListFinancialEventsResponse;
...
class FinancesApi {
     ...
     * @param string $next_token A string token returned in the response of your previous request. (optional)
     *
     * @return array of \SellerLegend\AmazonSellingPartnerAPI\Models\Finances\ListFinancialEventGroupsResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     *
     * @throws InvalidArgumentException
     */
    ...
    public function listFinancialEventGroupsAsyncWithHttpInfo($max_results_per_page = '100', $financial_event_group_started_before = null, $financial_event_group_started_after = null, $next_token = null) {
        $returnType = '\SellerLegend\AmazonSellingPartnerAPI\Models\Finances\ListFinancialEventGroupsResponse';
        $request = $this->listFinancialEventGroupsRequest($max_results_per_page, $financial_event_group_started_before, $financial_event_group_started_after, $next_token);
     ...
     * @param string $next_token A string token returned in the response of your previous request. (optional)
     *
     * @return array of \SellerLegend\AmazonSellingPartnerAPI\Models\Finances\ListFinancialEventsResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     *
     * @throws InvalidArgumentException
     */
    ...
    public function listFinancialEventsByGroupId($event_group_id, $max_results_per_page = '100', $posted_after = null, $posted_before = null, $next_token = null) {
        [$response] = $this->listFinancialEventsByGroupIdWithHttpInfo($event_group_id, $max_results_per_page, $posted_after, $posted_before, $next_token);
