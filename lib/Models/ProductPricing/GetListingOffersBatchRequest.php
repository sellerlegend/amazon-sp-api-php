...
class GetListingOffersBatchRequest implements ModelInterface, ArrayAccess, JsonSerializable, IteratorAggregate {
    ...
    protected static $swaggerTypes = [
        'requests' => '\SellerLegend\AmazonSellingPartnerAPI\Models\ProductPricing\ListingOffersRequest[]'
    ];
     ...
     * Gets requests
     *
     * @return ListingOffersRequest[]|null
     */
     ...
     * Sets requests
     *
     * @param ListingOffersRequest[]|null $requests A list of getItemOffers batched requests to run.
     *
     * @return self
     */
     ...
     * @return GetListingOffersBatchRequest
     */
