...
class CreateInboundShipmentPlanResult implements ModelInterface, ArrayAccess {
    ...
    protected static $swaggerTypes = [
        'inbound_shipment_plans' => '\SellerLegend\AmazonSellingPartnerAPI\Models\FulfillmentInbound\InboundShipmentPlanList'
    ];
     ...
     *
     * @return InboundShipmentPlanList
     */
     ...
     *
     * @param InboundShipmentPlanList $inbound_shipment_plans inbound_shipment_plans
     *
     * @return $this
     */
