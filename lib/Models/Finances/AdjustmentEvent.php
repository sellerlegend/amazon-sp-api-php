...
class AdjustmentEvent implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate {
    ...
    protected static $swaggerTypes = [
        ...
        'adjustment_item_list' => '\SellerLegend\AmazonSellingPartnerAPI\Models\Finances\AdjustmentItem[]'
    ];
     ...
     *
     * @param Currency|null $adjustment_amount adjustment_amount
     *
     * @return self
     */
     ...
     *
     * @param AdjustmentItem[]|null $adjustment_item_list A list of information about items in an adjustment to the seller's account.
     *
     * @return self
     */
