...
class ServiceJob implements ModelInterface, ArrayAccess {
    ...
    protected static $swaggerTypes = [
        ...
        'service_job_id'              => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\ServiceJobId',
        'service_job_status'          => 'string',
        'scope_of_work'               => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\ScopeOfWork',
        'seller'                      => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\Seller',
        'service_job_provider'        => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\ServiceJobProvider',
        'preferred_appointment_times' => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\AppointmentTime[]',
        'appointments'                => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\Appointment[]',
        'service_order_id'            => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\OrderId',
        'marketplace_id'              => 'string',
        'buyer'                       => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\Buyer',
        'associated_items'            => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\AssociatedItem[]',
        'service_location'            => '\SellerLegend\AmazonSellingPartnerAPI\Models\Services\ServiceLocation',];
     ...
     * Sets service_job_id.
     *
     * @param ServiceJobId $service_job_id service_job_id
     *
     * @return $this
     */
     ...
     * Sets scope_of_work.
     *
     * @param ScopeOfWork $scope_of_work scope_of_work
     *
     * @return $this
     */
     ...
     *
     * @param ServiceJobProvider $service_job_provider service_job_provider
     *
     * @return $this
     */
     ...
     *
     * @param AppointmentTime[] $preferred_appointment_times A list of appointment windows preferred by the buyer. Included only if the buyer selected appointment windows when creating the order.
     *
     * @return $this
     */
     ...
     *
     * @param OrderId $service_order_id service_order_id
     *
     * @return $this
     */
     ...
     *
     * @param AssociatedItem[] $associated_items a list of items associated with the service job
     *
     * @return $this
     */
     ...
     *
     * @param ServiceLocation $service_location service_location
     *
     * @return $this
     */
