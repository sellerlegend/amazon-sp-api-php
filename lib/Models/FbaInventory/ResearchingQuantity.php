...
class ResearchingQuantity implements ModelInterface, ArrayAccess {
    ...
    protected static $swaggerTypes = [
        ...
        'researching_quantity_breakdown' => '\SellerLegend\AmazonSellingPartnerAPI\Models\FbaInventory\ResearchingQuantityEntry[]',];
     ...
     *
     * @return ResearchingQuantityEntry[]
     */
     ...
     *
     * @param ResearchingQuantityEntry[] $researching_quantity_breakdown a list of quantity details for items currently being researched
     *
     * @return $this
     */
